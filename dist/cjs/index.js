...
const Button = React.forwardRef(function Button({ children, variant = "text", color = "primary", size = "medium", disabled = false, startIcon, endIcon, fullWidth = false, style, className, ...rest }, ref) {
    ...
    return (jsxRuntime.jsxs("button", { ref: ref, style: baseStyles, className: className, disabled: disabled, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...rest, children: [startIcon && jsxRuntime.jsx("span", { style: { display: "flex", marginLeft: "-4px", marginRight: "8px" }, children: startIcon }), children, endIcon && jsxRuntime.jsx("span", { style: { display: "flex", marginRight: "-4px", marginLeft: "8px" }, children: endIcon })] }));
});
