...
- `onChange` — Function called when user selects a date, receives the new Date or null
...
- **What it does:** Called when user selects or clears a date
- **Parameters:**
